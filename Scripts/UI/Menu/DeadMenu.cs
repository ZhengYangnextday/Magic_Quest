...

{
    ...
    private void AssemblyInstantiate(){
        background = Instantiate(Resources.Load("Test_UI/DeadMenu/background") as GameObject);
        restart = Instantiate(Resources.Load("Test_UI/DeadMenu/restart") as GameObject);
        ...
        menu = Instantiate(Resources.Load("Test_UI/DeadMenu/menu") as GameObject);
